  ...
  return (
    <header>
      <div className={style.icons}>
        <i className="fas fa-search" onClick={handleSearchClear}></i>
        <input
          type="text"
      ...
      {props.contacts.map((contact) => {
        if (id === contact._id) {
          return (
            <div key={contact._id} className={style.user}>
              <div>{contact.fullname}</div>
              <div className={contact.online ? style.online : style.none}></div>
            </div>
          );
        } else {
          return false;
      ...
      <div className={style.icons}>
        <i className="fas fa-cog" onClick={handleChangeProfile}></i>
      </div>
    </header>
  );
}
